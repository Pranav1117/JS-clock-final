...
let alarmbtn = document.getElementById('btn');
    ...
    function execute()
    {
        ...
        wakeuptiming.innerText='Wake Up Time :' + firstdropdown.options[firstdropdown.selectedIndex].text;
        ...
        lunchtiming.innerText='Lunch Time :'+ seconddropdown.options[seconddropdown.selectedIndex].text;
        ...
        naptiming.innerText='Nap Time :'+ thirddropdown.options[thirddropdown.selectedIndex].text;
        ...
        nighttiming.innerText='Night Time :'+ fourthdropdown.options[fourthdropdown.selectedIndex].text ;
